  ...
  return (
    <div className='lg:mt-[400px]'>
      <Container>
        ...
        <div className='flex 2xl:space-x-[150px] xl:space-x-[90px] gap-x-10 xl:gap-x-0'>

          {/* left side */}
          <div className='lg:w-[55%]'>

            {/* card 1  */}
            <div className='border border-[#775A34] bg-[#301F0C] lg:px-7 py-3 lg:py-5 xl:py-7 rounded-[16px] lg:mb-[30px]'>
            ...
            {/* card 4  */}
            <div className='border border-[#775A34] bg-[#301F0C] lg:px-7 py-3 lg:py-5 xl:py-7 rounded-[16px]'>
              <p className='text-[#FBA32C] font-passeroOne text-[20px] xl:text-[24px] leading-[33.6px] lg:pb-[12px] xl:pb-[18px] uppercase'>What is Loffar Frog?</p>
          ...
          <div className='lg:w-[45%] lg:mt-[-75px]'>
            ...
            <p className='text-[#FBA32C] font-pantonRust font-medium lg:text-[65px] md:text-[60px] text-[30px] xl:text-[115px] leading-[138px] tracking-[2.3px] xl:mb-[16px]'>Faq</p>

            <p className='text-[#B2ACA8] font-passeroOne text-[17px] lg:text-[19px] xl:text-[17px] 2xl:text-[20px] lg:leading-[34px] lg:tracking-[0.4px] lg:mb-[50px] xl:w-[90%]'>Explore our FAQ section for quick answers to common queries about Loffar Frog, your gateway to creativity and innovation.</p>

            <div className='2xl:w-[700px] xl:w-[500px]'>
              <img className='xl:ml-[-60px] lg:h-[500px] xl:h-[600px] 2xl:h-auto' src={faqImg} alt="image" />
            </div>
