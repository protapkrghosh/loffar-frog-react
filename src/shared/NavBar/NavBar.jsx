        ...
        <div className="w-full top-0 left-0 z-10 bg-[#FBA32C] rounded-[10px]">
          <div className={`md:flex justify-between items-center ${color ? 'py-3' : 'py-5'}`}>
            ...
            <ul className={`md:flex md:items-center md:py-3 pt-5 pb-7 space-x-1 space-y-4 md:space-y-0 absolute md:static md:z-auto z-[-1px] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-linear opacity-0 md:opacity-100 rounded-[5px] ${open ? 'top-[75px] opacity-100 bg-[#e1b9b4] z-10' : 'top-[-490px]'}`}>
              ...
              <li>
                <Link to="about" smooth={true} offset={-30} duration={600} className={`text-[18px] font-passeroOne ml-5 md:ml-5 cursor-pointer rounded-[4px] px-4 py-3 border border-transparent ${activeLink === "home" ? ' text-[#1E1510] border-[#1E1510] bg-[#fcb95f]' : 'hover:bg-[#fcb95f] hover:border-[#1E1510] duration-200'}`} onClick={() => setActiveLink("home")}>About</Link>
              </li>

              <li>
                <Link to="tokenomics" smooth={true} offset={0} duration={600} className={`text-[18px] font-passeroOne duration-300 cursor-pointer rounded-[4px] px-4 py-3 border border-transparent ${activeLink === "tokenomics" ? 'text-[#1E1510] border-[#1E1510] bg-[#fcb95f]' : 'hover:bg-[#fcb95f] hover:border-[#1E1510] duration-200'}`} onClick={() => setActiveLink("tokenomics")}>Tokenomics</Link>
              </li>

              <li>
                <Link to="roadmap" smooth={true} offset={10} duration={600} className={`text-[18px] font-passeroOne duration-300 cursor-pointer rounded-[4px] px-4 py-3 border border-transparent ${activeLink === "roadmap" ? 'text-[#1E1510] border-[#1E1510] bg-[#fcb95f]' : 'hover:bg-[#fcb95f] hover:border-[#1E1510] duration-200'}`} onClick={() => setActiveLink("roadmap")}>Roadmap</Link>
              </li>

              <li>
                <Link to="partners" smooth={true} offset={10} duration={600} className={`text-[18px] font-passeroOne duration-300 cursor-pointer rounded-[4px] px-4 py-3 border border-transparent ${activeLink === "partners" ? 'text-[#1E1510] border-[#1E1510] bg-[#fcb95f]' : 'hover:bg-[#fcb95f] hover:border-[#1E1510] duration-200'}`} onClick={() => setActiveLink("partners")}>Faq</Link>
              </li>
            ...
            <div className="md:block hidden">
              <div className="flex items-center">
                <div className='flex gap-[14px]'>
                  <a href="" target='_blank' className='text-[#1E1510] px-3 py-3 border border-[#1E1510] hover:bg-[#301F0C] rounded-[5px]'><FaTwitter className='w-[24px] h-[24px]' /></a>

                  <a href="" target='_blank' className='text-[#1E1510] px-3 py-3 border border-[#1E1510] hover:bg-[#301F0C] rounded-[5px]'><FaTelegramPlane className='w-[24px] h-[24px]' /></a>

                  <a href="" target='_blank' className='text-[#1E1510] px-3 py-3 border border-[#1E1510] hover:bg-[#301F0C] rounded-[5px]'><PiGithubLogoFill className='w-[24px] h-[24px]' /></a>
                </div>

                <Link to="home" smooth={true} offset={-30} duration={600}>
                  <Button className="bg-[#fcb95f] text-[#1E1510] rounded-[4px] border border-[#1E1510] text-[16px] font-passeroOne font-normal mr-5">contract</Button>
                </Link>
              </div>
            </div>
          </div>
